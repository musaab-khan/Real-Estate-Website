...
const Navbar = () => {
  ...
  return (
        ...
        <nav className="light bg-[#f3f3f3] flex justify-between items-center gap-4 lg:px-20 px-4 py-3 sticky top-0 z-30 dark:bg-black">
            ...
            <ul className={`flex-row justify-between  items-center w-screen h-fit p-5 fixed top-[80px] text-center left-0 bg-slate-800 text-white gap-5 menu lg:flex lg:flex-row lg:p-0 lg:bg-transparent lg:gap-8 lg:w-fit lg:text-black lg:static dark:text-white ${menuVisibility?'':'hidden'}`} id='menu'>
                <li className='px-3 py-2 hover:bg-red-600 hover:text-white rounded-md cursor-pointer font-semibold uppercase'>Home</li>
                <li className='px-3 py-2 hover:bg-red-600 hover:text-white rounded-md cursor-pointer font-semibold uppercase'>About</li>
                <li className='px-3 py-2 hover:bg-red-600 hover:text-white rounded-md cursor-pointer font-semibold uppercase'>Properties</li>
                <li className='px-3 py-2 hover:bg-red-600 hover:text-white rounded-md cursor-pointer font-semibold uppercase'>Services</li>
                <li className='px-3 py-2 hover:bg-red-600 hover:text-white rounded-md cursor-pointer font-semibold uppercase'>Testimonials</li>
                <li className='px-3 py-2 hover:bg-red-600 hover:text-white rounded-md cursor-pointer font-semibold uppercase'>Contact</li>
            </ul>
            <div className='svgs'>
            ...
            <div className='flex justify-between items-center gap-2 lg:gap-8 phone dark:text-white'>
                <div className="phone flex justify-between items-center  gap-1 lg:gap-3">
                    ...
                    <a className='font-semibold'>0317-4231186</a>
                </div>
