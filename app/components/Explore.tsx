...
const Explore = () => {
  ...
  return (
    <div className="light bg-transparent dark:bg-black">
        <section className="light bg-red-100 lg:w-[95%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex justify-center flex-col items-center lg:px-20 px-6 py-20 gap-20 dark:bg-gray-800">
            <div id="top" className="w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8">
                <div>
                    <h1  className={`text-red-500 dark:text-red zoomer ${visibleElements[1]?'animate-zoomIn':'animate-zoomOut'} dark:text-white`}>POPULAR AREAS</h1>
                    <h1 className={`text-black text-[40px] font-semibold leading-10 mt-4 zoomer ${visibleElements[2]?'animate-zoomIn':'animate-zoomOut'} dark:text-white`}>Explore most<br/>popular areas</h1>
                </div>
