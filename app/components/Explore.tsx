        ...
        <section className="light bg-red-100 lg:w-[95%] w-full h-fit m-auto bg-cover bg-center rounded-xl flex justify-center flex-col items-center lg:px-20 px-6 py-20 gap-20 dark:bg-gray-800">
            <div className="w-full grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-8">
                ...
                <div className="grid lg:grid-cols-3 col-span-2 grid-cols-1 justify-center items-center gap-6">
                    <div className={`${visibleElements[2]?'animate-zoomIn':'animate-zoomOut'} exploreZoomer h-[400px] bg-cover bg-center rounded-xl `}style={{ backgroundImage: 'url("/assets/explore-1.jpg")' }}></div>
                    <div className={`${visibleElements[2]?'animate-zoomIn':'animate-zoomOut'} h-[400px] bg-cover bg-center rounded-xl `}style={{ backgroundImage: 'url("/assets/explore-2.jpg")' }}></div>
                    <div className={`${visibleElements[2]?'animate-zoomIn':'animate-zoomOut'} h-[400px] bg-cover bg-center rounded-xl `}style={{ backgroundImage: 'url("/assets/explore-3.jpg")' }}></div>
                </div>
            </div>
            <div className="w-full grid lg:grid-cols-3 grid-cols-1 lg:justify-center justify-start items-start gap-6 relative">
                <div className={`${visibleElements[3]?'translate-y-0':'translate-y-[100%]'} exploreZoomer flex justify-center lg:items-center gap-8 w-full transition-all duration-[1s] ease`}>
                ...
                <div className={`${visibleElements[3]?'translate-y-0' :'translate-y-[100%]'} exploreZoomer flex justify-center lg:items-center gap-8 w-full transition-all duration-[1.5s] ease`}>
