...
const About = () => {
  ...
  return (
    <section
      id="about"
      className="dark bg-transparent w-full m-auto lg:px-40 px-10 py-20 grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-10"
    >
      {/* Image Section */}
      <div className={`${visibleElements[0]?'animate-zoomIn':'animate-zoomOut'}  lg:w-[500px] lg:h-[600px] bg-cover bg-center rounded-xl `}style={{ backgroundImage: 'url("/assets/About.jpg")' }}>1</div>

      {/* Text Section */}
      <div className="flex flex-col justify-center items-start gap-8">
        <h1
          className={`text-red-500 zoomer ${
            visibleElements[0] ? 'animate-zoomIn delay-200' : 'animate-zoomOut'
          } zoomer`}
        >
          WHO WE ARE
        </h1>
        ...
        <p
          ...
          } text-xl text-gray-600 text-justify zoomer dark:text-red-600`}
        >
