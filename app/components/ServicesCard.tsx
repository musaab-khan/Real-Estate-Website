...
const ServicesCard : React.FC<ServicesCardProps> = ({ imageSrc,propClass }) => {
  return (
    <div className={`${propClass} bg-white dark:bg-white h-[350px] px-8 py-16 flex flex-col justify-center items-start gap-4 rounded-xl border-b-[5px] border-red-600 hover:bg-red-300 cursor-pointer `}>
        ...
        <h1 className=" text-black text-[22px] font-semibold dark:text-black">Sell your home</h1>
        <p className="text-lg text-slate-700 dark:text-slate-700">We sell your home at the best market price</p>
